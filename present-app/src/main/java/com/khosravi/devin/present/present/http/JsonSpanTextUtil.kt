...
class JsonSpanTextUtil(private val jsonConfigColor: JsonConfigColor) {
    ...
    public fun spanJson(input: CharSequence): SpannableStringBuilder {
        ...
        val prettyPrintedInput = HttpFormatUtils.formatJson(input.toString())
        ...
        sb.setColor(0, prettyPrintedInput.length, jsonConfigColor.digitsAndNullValueColor)
            ...
            when (tokenType) {
                ...
                -> {
                    sb.setColor(
                        ...
                        color = jsonConfigColor.signElementsColor,
                    )
                    index = tokenIndex + 1
                }
    ...
    private fun SpannableStringBuilder.setBooleanColor(tokenIndex: Int): Int {
        ...
        setColor(
            ...
            color = jsonConfigColor.booleanColor,
        )
        return endIndex
    }
    ...
    private fun SpannableStringBuilder.setStringColor(
        ...
        val color =
            when (lastTokenType) {
                ...
                null,
                -> {
                    jsonConfigColor.keyColor
                }

                else -> {
                    jsonConfigColor.valueColor
                }
            }
    ...
    class MyForegroundColorSpan(color: Int) : ForegroundColorSpan(color)
}